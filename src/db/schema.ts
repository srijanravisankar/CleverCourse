...
export const courses = sqliteTable("courses", {
  ...
  level: text("level", { enum: ["beginner", "intermediate", "advanced", "expert"] }).notNull().default("beginner"),
  goal: text("goal").notNull(),
  tone: text("tone", { enum: ["professional", "casual", "technical"] }).notNull().default("professional"),
  ...
  // Status
  status: text("status", { enum: ["draft", "generating", "active", "completed", "archived"] }).notNull().default("draft"),
...
export const mcqQuestions = sqliteTable("mcq_questions", {
  ...
  isAttempted: integer("is_attempted", { mode: "boolean" }).notNull().default(false),
...
export const trueFalseQuestionsRelations = relations(trueFalseQuestions, ({ one }) => ({
  section: one(courseSections, {
...
export const fillUpQuestionsRelations = relations(fillUpQuestions, ({ one }) => ({
  section: one(courseSections, {
